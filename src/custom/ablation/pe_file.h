...
/// @return a pointer to a pe_file structure
...
/// @return the index of the section in the order it appears in the file or SECTION_NOT_FOUND if section name does not exist
...
/// @param file the pe file
/// @param name the name of the section
/// @return the size of the section in bytes or SECTION_NOT_FOUND if section name is not found
...
/// @return the number of bytes written, OUT_OF_BOUNDS if write would go beyond the header, and IO_ERROR if there is some error with io operations
...
/// @return the number of bytes written, OUT_OF_BOUNDS if write would go anywhere other than the section, IO_ERROR if there is some error with io operations
